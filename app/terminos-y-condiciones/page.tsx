      ...
      <div className="max-w-4xl mx-auto px-4 py-10">
        ...
        <nav aria-label="Ruta de navegación" className="mb-6">
          <ol className="flex items-center gap-3 text-sm">
            ...
            <li className="text-brand-primary font-medium">Términos y Condiciones</li>
          </ol>
        </nav>

        <article className="bg-white rounded-2xl shadow-sm p-6 sm:p-10">
          <h1 className="text-2xl sm:text-3xl font-bold text-brand-primary mb-2">Términos y Condiciones</h1>
          ...
          <div className="prose prose-slate max-w-none text-sm sm:text-base leading-relaxed space-y-6 text-slate-700">
            ...
            <section>
              <h2 className="text-lg font-semibold text-brand-primary mb-2">1. Aceptación de los términos</h2>
              <p>
            ...
            <section>
              <h2 className="text-lg font-semibold text-brand-primary mb-2">2. Naturaleza informativa del contenido</h2>
              <p>
            ...
            <section>
              <h2 className="text-lg font-semibold text-brand-primary mb-2">3. Mercado informal (dólar blue)</h2>
              <p>
            ...
            <section>
              <h2 className="text-lg font-semibold text-brand-primary mb-2">4. Limitación de responsabilidad</h2>
              <p>
            ...
            <section>
              <h2 className="text-lg font-semibold text-brand-primary mb-2">5. Propiedad intelectual</h2>
              <p>
            ...
            <section>
              <h2 className="text-lg font-semibold text-brand-primary mb-2">6. Uso aceptable</h2>
            ...
            <section>
              <h2 className="text-lg font-semibold text-brand-primary mb-2">7. Modificaciones al servicio</h2>
              <p>
            ...
            <section>
              <h2 className="text-lg font-semibold text-brand-primary mb-2">8. Cambios a estos términos</h2>
              <p>
            ...
            <section>
              <h2 className="text-lg font-semibold text-brand-primary mb-2">9. Jurisdicción y ley aplicable</h2>
              <p>
            ...
            <section>
              <h2 className="text-lg font-semibold text-brand-primary mb-2">10. Contacto</h2>
              <p>
