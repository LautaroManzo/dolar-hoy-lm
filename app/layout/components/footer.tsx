      ...
      <div className="max-w-6xl mx-auto px-6 py-8">
        ...
        <div className="flex justify-center mb-6">
          <a
            ...
            className="flex items-center gap-3 bg-white/10 hover:bg-black/20 rounded-full px-5 py-2.5 transition-colors duration-200"
          >
            ...
            <span className="text-sm font-medium">Cotizaciones del dólar todos los días a las 17hs</span>
          </a>
        </div>
